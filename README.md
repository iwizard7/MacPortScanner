...
MacPortScanner автоматически определяет тип сервиса на открытых портах:

- **HTTP/HTTPS** - Анализ HTTP заголовков и HTML title
...
- **И другие** - Поддержка популярных сервисов
